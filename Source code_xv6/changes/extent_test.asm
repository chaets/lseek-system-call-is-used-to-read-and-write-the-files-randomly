...
_extent_test:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  14:	c7 44 24 04 88 07 00 	movl   $0x788,0x4(%esp)
  1b:	00 
  1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  23:	e8 f8 03 00 00       	call   420 <printf>
		exit();
  28:	e8 a5 02 00 00       	call   2d2 <exit>
	}
	//printf("%s",argv[1]);

		int fd=open(argv[1],O_RDWR|O_CREATE|O_EXTENT);
  2d:	c7 44 24 04 06 02 00 	movl   $0x206,0x4(%esp)
  34:	00 
  35:	8b 43 04             	mov    0x4(%ebx),%eax
  38:	89 04 24             	mov    %eax,(%esp)
  3b:	e8 d2 02 00 00       	call   312 <open>
		printf(1,"%d",fd);
  40:	c7 44 24 04 a2 07 00 	movl   $0x7a2,0x4(%esp)
  47:	00 
  ...
  55:	e8 c6 03 00 00       	call   420 <printf>
		char* str="H rldHello WorldHello WorldHello World Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WordHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello World Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello World Hello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello WorldHello ";
		write(fd,str,strlen(str)+1);
  5a:	c7 04 24 a8 07 00 00 	movl   $0x7a8,(%esp)
  61:	e8 ca 00 00 00       	call   130 <strlen>
  66:	c7 44 24 04 a8 07 00 	movl   $0x7a8,0x4(%esp)
  6d:	00 
  6e:	89 34 24             	mov    %esi,(%esp)
  71:	83 c0 01             	add    $0x1,%eax
  74:	89 44 24 08          	mov    %eax,0x8(%esp)
  78:	e8 75 02 00 00       	call   2f2 <write>
		
		close(fd);
  7d:	89 34 24             	mov    %esi,(%esp)
  80:	e8 75 02 00 00       	call   2fa <close>
		printf(1,"An EXTENT based file, named %s is created\n", argv[1] );
  85:	8b 43 04             	mov    0x4(%ebx),%eax
  88:	c7 44 24 04 2c 0a 00 	movl   $0xa2c,0x4(%esp)
  8f:	00 
  90:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  97:	89 44 24 08          	mov    %eax,0x8(%esp)
  9b:	e8 80 03 00 00       	call   420 <printf>
	...
	exit();
  a0:	e8 2d 02 00 00       	call   2d2 <exit>
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
  ab:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 5f 0a 00 00 	movzbl 0xa5f(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 58 0a 00 00       	mov    $0xa58,%eax
...
free(void *ap)
{
 ...
 611:	a1 d8 0c 00 00       	mov    0xcd8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 657:	89 10                	mov    %edx,(%eax)
  freep = p;
 659:	a3 d8 0c 00 00       	mov    %eax,0xcd8
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 682:	a3 d8 0c 00 00       	mov    %eax,0xcd8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d d8 0c 00 00    	mov    0xcd8,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 d8 0c 00 00    	cmp    0xcd8,%edx
...
morecore(uint nu)
{
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 d8 0c 00 00    	mov    0xcd8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 744:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 747:	89 15 d8 0c 00 00    	mov    %edx,0xcd8
      return (void*)(p + 1);
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 d8 0c 00 00 dc 	movl   $0xcdc,0xcd8
 765:	0c 00 00 
    base.s.size = 0;
 768:	ba dc 0c 00 00       	mov    $0xcdc,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 dc 0c 00 00 dc 	movl   $0xcdc,0xcdc
 774:	0c 00 00 
    base.s.size = 0;
 777:	c7 05 e0 0c 00 00 00 	movl   $0x0,0xce0
 77e:	00 00 00 
