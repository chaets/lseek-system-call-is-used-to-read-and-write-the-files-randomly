...
_extent:     file format elf32-i386
...
int main(int argc, char* argv[]){
  ...
  14:	c7 44 24 04 68 07 00 	movl   $0x768,0x4(%esp)
  1b:	00 
  1c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  23:	e8 d8 03 00 00       	call   400 <printf>
		exit();
  ...
  3b:	e8 b2 02 00 00       	call   2f2 <open>
	char* str="Hello";
	write(fd,str,strlen(str)+1);
  40:	c7 04 24 82 07 00 00 	movl   $0x782,(%esp)
int main(int argc, char* argv[]){
	if(argc!=2){
		printf(1,"error: path not provided\n" );
		exit();
  ...
  47:	89 c6                	mov    %eax,%esi
	char* str="Hello";
	write(fd,str,strlen(str)+1);
  49:	e8 c2 00 00 00       	call   110 <strlen>
  4e:	c7 44 24 04 82 07 00 	movl   $0x782,0x4(%esp)
  55:	00 
  56:	89 34 24             	mov    %esi,(%esp)
  59:	83 c0 01             	add    $0x1,%eax
  5c:	89 44 24 08          	mov    %eax,0x8(%esp)
  60:	e8 6d 02 00 00       	call   2d2 <write>
	close(fd);
  65:	89 34 24             	mov    %esi,(%esp)
  68:	e8 6d 02 00 00       	call   2da <close>
	printf(1,"You have create an extent file name called: %s\n", argv[1]);
  6d:	8b 43 04             	mov    0x4(%ebx),%eax
  70:	c7 44 24 04 88 07 00 	movl   $0x788,0x4(%esp)
  77:	00 
  78:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  7f:	89 44 24 08          	mov    %eax,0x8(%esp)
  83:	e8 78 03 00 00       	call   400 <printf>
	exit();
  88:	e8 25 02 00 00       	call   2b2 <exit>
  8d:	66 90                	xchg   %ax,%ax
  8f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 399:	0f b6 92 bf 07 00 00 	movzbl 0x7bf(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 52f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 531:	b8 b8 07 00 00       	mov    $0x7b8,%eax
...
free(void *ap)
{
 ...
 65f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 662:	a3 38 0a 00 00       	mov    %eax,0xa38
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 1d 38 0a 00 00    	mov    0xa38,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6c9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6cb:	3b 15 38 0a 00 00    	cmp    0xa38,%edx
...
morecore(uint nu)
{
 ...
 6fd:	e8 ee fe ff ff       	call   5f0 <free>
  return freep;
 702:	8b 15 38 0a 00 00    	mov    0xa38,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 73c:	eb e9                	jmp    727 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 73e:	c7 05 38 0a 00 00 3c 	movl   $0xa3c,0xa38
 745:	0a 00 00 
    base.s.size = 0;
 748:	ba 3c 0a 00 00       	mov    $0xa3c,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 74d:	c7 05 3c 0a 00 00 3c 	movl   $0xa3c,0xa3c
 754:	0a 00 00 
    base.s.size = 0;
 757:	c7 05 40 0a 00 00 00 	movl   $0x0,0xa40
 75e:	00 00 00 
